...
router.post('/predict', async (req, res) => {
  ...
  try {
    ...
    let mlResponse;
    try {
      mlResponse = await axios.post(mlApiUrl, { url }, {
    ...
    try {
      const predictionRecord = new Prediction({
        url,
        prediction: prediction === 'phishing' ? true : false,
    ...
    // Map prediction to extension-friendly format with safe host overrides
